...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/room/registerInUIEntity.shtml">
		...
		<div class="panel-body">
			...
			<div class="form-group" id="selGuest" data-url="/guest/getGuestListDiv.shtml"></div>
			<div class="line line-dashed line-lg pull-in"></div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label" style="width:20%">房租价格</label>
				<div class="col-sm-9" style="width:80%">
					<input type="text" class="form-control checkacc" placeholder="请输入房租价格" value="${room.roomPrice}" name="room.roomPrice" id="room.roomPrice">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
