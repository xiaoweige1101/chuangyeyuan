...
<script type="text/javascript" src="${ctx}/js/system/room/registerOutUI.js"></script>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入用户名" value="${room.roomName}" name="room.roomName" id="roomName" readonly="readonly">
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">当前房客</label>
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc" placeholder="请输入账号" value="${user.accountName}" name="userFormMap.accountName" id="accountName" readonly="readonly">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
